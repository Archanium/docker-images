...
docker build --tag "byflou/${PROJECT}:php8.0${POSTFIX}" --build-arg PHP_VERSION=8.0-cli .
#docker build --tag "byflou/${PROJECT}:php8.1${POSTFIX}" --build-arg PHP_VERSION=8.1-cli --tag "byflou/${PROJECT}:${LATEST_TAG}" .
